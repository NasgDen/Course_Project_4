...
from users.views import (BlockUserView, EditCustomUser, RegistrationView, UserDetailView, UserListView,
                         UserPasswordChangeView, UserPasswordReset, UserPasswordResetCompleteView,
                         UserPasswordResetConfirmView, UserPasswordResetDoneView, email_varification)
...
urlpatterns = [
    ...
    path("user_detail/block_user/<int:pk>/", BlockUserView.as_view(), name="block_user"),
]
