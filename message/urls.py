...
from .views import (DisablingView, DistributionCreateView, DistributionDeleteView, DistributionDetailView,
                    DistributionListView, DistributionUpdateView, IndexListView, MailingRecipientCreateView,
                    MailingRecipientDeleteView, MailingRecipientDetailView, MailingRecipientListView,
                    MailingRecipientUpdateView, MessageCreateView, MessageDeleteView, MessageDetailView,
                    MessageListView, MessageUpdateView, SendMessageView, StatisticView)
...
urlpatterns = [
    ...
    path("distribution_detail/block_distribution/<int:pk>/", DisablingView.as_view(), name="block_distribution"),
]
